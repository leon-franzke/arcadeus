...
const RIGHT_YS = [-112, -37, 37, 112].map(d => CY + d);
...
const EcosystemMap = () => {
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      {/* column labels — no animation, always visible */}
      <text x={LX + NODE_W / 2} y={30} textAnchor="middle"
        fill="rgba(0,0,0,0.28)" fontSize="9"
        fontFamily="Inter, sans-serif" fontWeight="600" letterSpacing="0.12em">
        BANKS &amp; ACCOUNTS
      </text>
      <text x={RX + NODE_W / 2} y={30} textAnchor="middle"
        fill="rgba(0,0,0,0.28)" fontSize="9"
        fontFamily="Inter, sans-serif" fontWeight="600" letterSpacing="0.12em">
        TOOLS &amp; PLATFORMS
      </text>
